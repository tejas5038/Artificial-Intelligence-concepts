...
def main(argv):
	#argv = ["check","wumpus_rules.txt","additional_knowledge.txt","statement.txt"]
	#argv = ["check","wumpus_rules.txt","aaa.txt","c1.txt"]
	if(len(argv)!=4):
	...
	for line in input_file:
		...
		knowledge_base.subexpressions.append(subexpression)
	input_file.close()
	#print("knowledge base____-------____---->"+str(knowledge_base))
